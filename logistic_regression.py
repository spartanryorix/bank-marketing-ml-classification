...
plt.figure()
plt.plot(fpr, tpr, label=f"Logistic Regression ROC Curve (AUC = {roc_auc:.2f})")
plt.plot([0, 1], [0, 1], '--')
...
# Coefficient importance (instead of feature importance)
...
prediction = log_reg.predict(new_cus)
